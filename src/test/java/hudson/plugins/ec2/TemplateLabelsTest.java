...
public class TemplateLabelsTest extends HudsonTestCase{
	...
	public void setUp() throws Exception{
      ...
      SlaveTemplate template = new SlaveTemplate("ami", "foo", "default", "zone", "22", InstanceType.M1Large, LABEL1 + " " + LABEL2, "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", true, "subnet 456", tags, null, false, false, null);
    ...
    public void testEmptyLabel() throws Exception{
        ...
        SlaveTemplate temp = new SlaveTemplate("ami", "foo", "default", "zone", "22", InstanceType.M1Large, "", "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", true, "subnet 456", tags, null, false, false, null);
        List<SlaveTemplate> templates = new ArrayList<SlaveTemplate>();
        templates.add(temp);
