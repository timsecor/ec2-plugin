...
public class SlaveTemplateTest extends HudsonTestCase {
    ...
    public void testConfigRoundtrip() throws Exception {
        ...
        SlaveTemplate orig = new SlaveTemplate(ami, EC2Slave.TEST_ZONE, "default", "foo", "22", InstanceType.M1Large, "ttt", "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", false, "subnet 456", tags, null, false, false, null);
    ...
    public void testConfigRoundtripWithPrivateDns() throws Exception {
        ...
        SlaveTemplate orig = new SlaveTemplate(ami, EC2Slave.TEST_ZONE, "default", "foo", "22", InstanceType.M1Large, "ttt", "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", false, "subnet 456", tags, null, true, false, null);
